...
/**
 * Utility class for safely storing and checking passwords.
 *
 * Passwords are never decoded and never stored as plain text.
 * Instead, the class stores this text format:
 *
 *   PBKDF2WithHmacSHA256:120000:base64Salt:base64Hash
 *
 * During login, the entered password is hashed again with the stored salt.
 * If the newly calculated hash equals the stored hash, the password is correct.
 */
